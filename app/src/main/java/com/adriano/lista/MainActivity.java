    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		lvLista.setOnItemClickListener(new AdapterView.OnItemClickListener() { 
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long l) {
				...
				Toast.makeText(getApplicationContext(), "Lista: "+nomeLista+"\n"+"Id: "+idLista, Toast.LENGTH_SHORT).show();
		...
		public void showDialog() {
			...
			dialogBuilder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int p) {
						...
						if(edt_nome_lista.getText().toString().trim().equals("")){
							edt_nome_lista.setError("Opss, Digite algo.");
							return;
						} else {
							Lista lista = new Lista(txt_nome_lista, Calendar.getInstance().getTime(), false);
